...
if __name__ == "__main__":
    climate = read_climate_data("./data/data_semisynthetic.xlsx", sheet_name="climate")

    site_data = read_site_data("./data/data_semisynthetic.xlsx", sheet_name="site")

    species_data = read_species_data("./data/data_semisynthetic.xlsx", sheet_name="species")

    params_df = pl.read_excel("./data/data_semisynthetic.xlsx", sheet_name="parameters")
